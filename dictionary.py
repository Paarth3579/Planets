...
#print("Solar System {} Has maximum planets {} out of all Solar System we have discovered so far".format(max_solar_system,solar_system_planet_count[max_solar_system]))
